...
The logfile of bulb status created in this way can be used to replay the normal bulb usage pattern by ikea_tradfi_bulbGhost.py. The input data is extracted from the logfile by ikea_tradfi_log_analyze.R
